...
#pagebreak()
= ТЕКСТ ПРОГРАММЫ
Полный текст программы расположен в GitHub-репозитории UARTman/bathesis @gh.
...
- Language.Reflection.Unification (src/Language/Reflection/Unification.idr и папка src/Language/Reflection/Unification/) -- Содержит реализацию унификации выражений Idris2.
